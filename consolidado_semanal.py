...
def main():
    ...
    global FECHA_MINIMA, FECHA_MAYOR, ACTUALIZAR_BASE, VERIFICAR_CON_BASE
    FECHA_MINIMA = "2021-01-01"
    FECHA_MAYOR = "2021-12-31"
    ACTUALIZAR_BASE = True
    VERIFICAR_CON_BASE = True

    # Aquí puedes agregar el resto del código para procesar el archivo y los parámetros adicionales
    # ...
...
def procesar_consolidado_semanal(ruta_archivo):
    global FECHA_MINIMA, FECHA_MAYOR, ACTUALIZAR_BASE, VERIFICAR_CON_BASE
...
# Si hay código que se ejecuta directamente, ponerlo en un if __name__ == "__main__":
if __name__ == "__main__":

    # Código de prueba o ejecución directa
    pass
