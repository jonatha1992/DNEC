...
from PySide6.QtWidgets import QCheckBox, QDateEdit, QLabel, QMainWindow, QProgressBar, QPushButton, QTableView, QVBoxLayout, QWidget
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setProperty(u"fixedSize", QSize(600, 400))
        ...
        self.btn_delete.setGeometry(QRect(540, 240, 75, 24))
        ...
        self.label_status_process.setAlignment(Qt.AlignCenter)
        ...
        self.tableView.setGeometry(QRect(220, 60, 401, 171))
